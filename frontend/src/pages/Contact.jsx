const Contact = () => {
  return (
    <>
      {/* Header */}
      <section className="bg-gradient-to-b from-indigo-50 via-white to-white border-b border-gray-100 py-4 sm:py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-xl sm:text-2xl font-extrabold mt-1 mb-1 tracking-tight text-gray-900">Contact Us</h1>
          <p className="text-gray-500 text-[10px] sm:text-xs max-w-xl mx-auto">
      ...
      <section className="py-4 sm:py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center">
            {/* Contact Info Card */}
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-8 space-y-5 sm:space-y-6 max-w-md w-full">
              <h2 className="text-base sm:text-xl font-bold text-gray-900 text-center mb-4">Contact Information</h2>
